...
// Capturar o evento de submit do formulário para obter os valores
form.onsubmit = (event) => {
  // Previne o comportamento padrão de recarregar o formulário
...
function updateTotals(){
  try {
    ...
    total = formatCurrancyBRL(total).toUpperCase().replace('R$', '')
